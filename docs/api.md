...
| `limit`  | `number` | maximum number of results (1-50, default 20) |
...
| `estimatedResults` | `number`  | YouTube's estimated number of results |
| `refinements`    | `string[]`  | available search refinement filters |
| `results`        | `object[]`  | array of video search results |
...
| `type`      | `string` | internal item type |
| `title`     | `string` | video title |
| `author`    | `string` | channel or author name |
| `description` | `string` | short description |
| `published` | `string` | published date text |
| `viewCount` | `string` | view count text |
| `duration`  | `string` | video duration text |
